...
const COMPONENTS: Record<string, [ZodAny, Io]> = {
  ...
  Survey: [T.survey, 'output'],
  SurveyResults: [T.surveyResults, 'output'],
  ...
  CreateSurveyInput: [T.createSurveyInput, 'input'],
  UpdateSurveyInput: [T.updateSurveyInput, 'input'],
  SubmitSurveyResponseInput: [T.submitSurveyResponseInput, 'input'],
...
const ROUTES: Route[] = [
  ...
  },
  {
    ...
    tag: 'Public',
    sec: 'public',
    summary: 'The active survey to show this visitor (segment-aware), or null',
    resp: ref('Survey'),
  },
  {
    method: 'post',
    path: '/public/survey/{id}/responses',
    tag: 'Public',
    sec: 'public',
    summary: 'Submit a survey response',
    body: 'SubmitSurveyResponseInput',
    status: 201,
  },
  {
    method: 'post',
  ...
  },
  {
    ...
    body: 'CreateSurveyInput',
    resp: ref('Survey'),
    status: 201,
  },
  {
    method: 'get',
    path: '/projects/{projectId}/surveys/{id}/results',
    tag: 'Surveys',
    sec: 'admin',
    summary: 'Aggregated results (NPS / CSAT / distribution / text)',
    resp: ref('SurveyResults'),
  },
  {
    method: 'patch',
    path: '/projects/{projectId}/surveys/{id}',
    tag: 'Surveys',
    sec: 'admin',
    summary: 'Update a survey (e.g. activate)',
    body: 'UpdateSurveyInput',
    resp: ref('Survey'),
  },
  {
    method: 'delete',
